...
<table class="table table-striped table-bordered table-hover">
	<tbody>
        ...
        <tr><td><strong>验证码长度：</strong></td>
            <td>
                <ZL:TextBox runat="server" ID="VerifyLen_T" class="form-control text_300" MaxLength="1" ValidType="IntPostive" />
                <div class="rd_green">长度推荐为2-9个字符之间</div>
            </td>
        </tr>
        <tr>
            <td><strong>验证码组成：</strong></td>
            <td>

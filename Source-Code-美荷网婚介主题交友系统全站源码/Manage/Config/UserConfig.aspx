...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <ul class="nav nav-tabs">
        ...
        <li><a href="#Tabs6" data-toggle="tab">提现配置</a></li>
    </ul>
    <div class="tab-content panel-body padding0">
        ...
        <div class="tab-pane" id="Tabs6">
            <table class="table table-bordered table-striped">
                <tr><td class="td_l text-right">最小提现金额：</td><td>
                    <ZL:TextBox runat="server" ID="WD_Min_T" class="form-control text_300" ValidType="IntPostive"/>
                    <div class="rd_green">单笔提现最小金额,最小值为1</div>
                                                            </td></tr>
                <tr><td class="text-right">最大提现金额：</td><td>
                    <ZL:TextBox runat="server" ID="WD_Max_T" class="form-control text_300" ValidType="IntZeroPostive"/>
                    <div class="rd_green">单笔提现最大金额,0为不限制</div>
                                                       </td></tr>
                <tr>
                    <td class="text-right">提现倍数：</td>
                    <td>
                        <ZL:TextBox runat="server" ID="WD_Multi_T" class="form-control text_300" ValidType="IntZeroPostive"/>
                        <div class="rd_green">提现金额必须是该值的倍数,0为即不限制</div>
                    </td>
                </tr>
                <tr><td class="text-right">提现手续费率：</td><td>
                    <div class="input-group text_s">
                        <asp:TextBox runat="server" ID="WD_FeePercent_T" class="form-control" />

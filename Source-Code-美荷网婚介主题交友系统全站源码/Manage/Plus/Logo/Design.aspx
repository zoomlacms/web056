<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Design.aspx.cs" Inherits="ZoomLaCMS.Manage.Plus.Logo.Design" MasterPageFile="~/Manage/I/Default.Master"%>
            ...
            <table class="table table-bordered table-striped">
                ...
                <tr class="text_tr item_tr"><td>文字属性</td><td>
                    <div class="input-group" style="width:520px;">
                        ...
                        <input type="text" class="form-control text_300" maxlength="15" id="text_text"/>
